...
------------------------------------
* Gráfico 2 (Sensibilidad / Tornado) incluye variables de modelo como
  costo de reentrenamiento, tasa de drift, y umbral de decisión óptimo,
  además de las variables financieras estándar.
* Gráfico 3 (Comparativa de Escenarios) puede comparar deployment costs
...
* ``{algorithm_mode}`` ("single" | "contrast") determina si el Gráfico 3
