"""Logistic Regression-only classification M3 notebook prompt."""
...
M3_NOTEBOOK_ALGO_PROMPT_CLASSIFICATION_LR_ONLY: str = build_classification_notebook_prompt(
    M3_NOTEBOOK_ALGO_PROMPT_CLASSIFICATION_LEGACY,
    CLASSIFICATION_NOTEBOOK_VARIANT_LR_ONLY,
)


__all__ = ["M3_NOTEBOOK_ALGO_PROMPT_CLASSIFICATION_LR_ONLY"]
