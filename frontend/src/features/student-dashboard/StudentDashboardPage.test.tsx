...
describe("StudentDashboardPage", () => {
    ...
    it("renders success state, supports local search, and keeps CTA states honest", () => {
        ...
        expect(screen.getByRole("link", { name: /Resolver caso/i })).toHaveAttribute("href", "/student/cases/case-1/resolve");
        expect(screen.getByText(/Aún no disponible/i)).toBeTruthy();
