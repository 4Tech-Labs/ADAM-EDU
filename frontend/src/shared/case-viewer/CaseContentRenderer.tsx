...
// Section 3.0.6 is hardcoded identically in all three classification notebook variants
// (lr_only / rf_only / lr_rf_contrast) in notebooks/_shared.py and notebook.py — verified
// stable across all current classification variants. If the notebook section numbering ever
// changes, this constant must be updated in sync with the backend notebook source files.
const NOTEBOOK_HEADING_REFS: Readonly<Record<string, string>> = {
    "seccion-como-leer-la-matriz-de-costos": "3.0.6",
};
